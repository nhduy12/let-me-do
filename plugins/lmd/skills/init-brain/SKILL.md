...
One-shot setup: agent starts blind, this command gives brain a skeleton graph extracted from the codebase. Run once per project after installing the plugin.
...
- Report grouped by app: proposed nodes + edges.
